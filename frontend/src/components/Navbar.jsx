...
function Navbar() {
  return (
    <div className='h-[80px] w-full top-0 fixed z-20 flex justify-around items-center bg-transparent backdrop-blur-xl'>
        ...
        <div className='border top-[12px] flex items-center justify-center border-[#6881FF] w-[134px] h-[53px] rounded-[12px]'>
